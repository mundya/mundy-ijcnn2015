...
The CPU benefits of the proposed simulation scheme are evident when we a similar model is fitted to the spike-based results shown in \figurename~\ref{fig:results/network-utilisation}.
