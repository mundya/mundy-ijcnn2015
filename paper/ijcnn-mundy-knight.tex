...
To avoid this \citeauthor*{Galluppi2012}\ suggested transmitting factored weight matrices and performing their multiplication on SpiNNaker.
  ...
  The dense synaptic weight matrices and high firing rates characteristic of neural networks built using the NEF lead to inefficient use of the SpiNNaker architecture.
