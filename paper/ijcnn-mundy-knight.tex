...
Memory usage reductions of the order of \SI{90}{\percent} are possible and in some cases it is possible to simulate 2000 neurons on a processing core, double the SpiNNaker architectural target.
  \end{abstract}
