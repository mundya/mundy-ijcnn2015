...
On this basis, as figure \ref{fig:results/network-utilisation} shows, if 70 neurons are used per-dimension, a 4-D ensemble will receive around 20 incoming spikes  per-timestep.
...
Here the CPU benefits of the new simulation scheme become clear as, when we fit a similar model to the spike-based results shown in figure~\ref{fig:results/network-utilisation} we obtain the following equation:
%
\begin{equation}
  t = 3 \cdot N^{2}
\end{equation}
